        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    ...
                    <p class="text-light mb-1"><i class="fas fa-map-marker-alt me-2"></i>Panchkalguri, Patharghata,
                        Nemai, Matigara, Darjeeling. West Bengal -734009</p>
                    <p class="text-light mb-1"><i class="fas fa-phone me-2"></i>+19 1234567890</p>
                    <p class="text-light"><i class="fas fa-envelope me-2"></i>iskconaagritech@gmail.com</p>
                </div>
            </div>
            <hr class="my-4 border-secondary">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-light mb-0">&copy; 2025 ISKCONA AGRI TECH PVT. LTD. All rights reserved.</p>
                </div>
