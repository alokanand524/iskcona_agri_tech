...
<head>
    ...
    <title>Fungicides - ISKCONA AGRI TECH</title>
        ...
        <div class="container">
            <div class="row plant-margin">
                <div class="col-lg-8 mx-auto text-center mb-5 insect">
                    <h2 class="section-title">Fungicides for Plants</h2>
                    <p class="text-muted">Explore some of the powerful fungicides which remove fungal infection and heal
                        the plants.</p>
                </div>
            </div>
